...
from .datasets import (  # isort:skip
    ...
    TopDownPoseTrack18Dataset, MendeleyPLDataset, MendeleyBottomUpDataset)
...
__all__ = [
    ...
    'AnimalLocustDataset', 'AnimalZebraDataset', 'AnimalPoseDataset', 'MendeleyPLDataset', 'MendeleyBottomUpDataset',
