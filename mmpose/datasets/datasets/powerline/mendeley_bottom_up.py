...
from .powerline_bottom_up_base_dataset import PowerlineBottomUpBaseDataset


@DATASETS.register_module()
class MendeleyBottomUpDataset(PowerlineBottomUpBaseDataset):
    """MendeleyPL dataset for bottom-up pose estimation.
    ...
    def __init__(self,
        ...
        self.ann_info['skeleton'] = [[0, 0], [1, 2], [2, 0]]
